...
import net.apispark.webapi.resource.server.TasksFlowUseridServerResource;
import net.apispark.webapi.resource.server.TasksModelsTrainUseridServerResource;
...
public class WebApiApplication extends Application {
    ...
    public static final String ROUTE_TASKSFLOWUSERID = "/tasks/flow/{userid}";

    public static final String ROUTE_TASKSMODELSTRAINUSERID = "/tasks/models/train/{userid}";
    ...
    public Router createApiRouter() {
        ...
        apiRouter.attach(ROUTE_TASKSFLOWUSERID, TasksFlowUseridServerResource.class);
        apiRouter.attach(ROUTE_TASKSMODELSTRAINUSERID, TasksModelsTrainUseridServerResource.class);
